            ...
            <div class="ml-3">
                ...
                >
                    <v-card-title style="font-size:1em">
                        <v-icon v-if="objReply.get('replied').id != objReply.get('user').id" small class="mr-2">mdi-reply</v-icon>
                    ...
                    <v-card-text class="black--text">
                        ...
                        <b
                        class="mr-1"
                        v-if="objReply.get('replied').id != objReply.get('user').id"
                        >{{objReply.get('replied').get("username")}},</b>
